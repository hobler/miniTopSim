...
def plot_beam_comparison():
    """
    Calculating and plotting the differen beam flux densities
    ...
    #Broad beam
    beam.init_beam_profile('constant')
    fbeam_constant = beam.get_fbeam(x=xvals)

    #Gaussian beam
    beam.init_beam_profile('Gaussian')
    fbeam_Gaussian = beam.get_fbeam(x=xvals, I=0.92e-13)

    #Error function beam
    beam.init_beam_profile('error function')
