...
config_file = os.path.join(filedir, 'yamamura_redep_1.cfg')
...
def test_calc_distance():
    ...
    calculates distance between yamamura_redep_1.srf and
    yamamura_redep_1.srf_save and tests it with treshold
    value calculated in calc_distance

    """

    srf_filename1 = os.path.join(filedir, 'yamamura_redep_1.srf')
    srf_filename2 = os.path.join(filedir, 'yamamura_redep_1.srf_save')
